<template>
  <div
    class="absolute top-0 h-full w-full z-50 flex justify-center items-start pt-10"
  >
    <div class="bg-green-450 flex items-center p-4">
      <img
      ...
      <img
        ...
        src="@/assets/sprite/svg/AlertClosingIcon.svg"
        alt="closing icon"
      />
    </div>
  </div>
